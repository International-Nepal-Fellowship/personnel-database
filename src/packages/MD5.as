package packages
 {	
	public class MD5 {
		/*
		 * Downloaded Date: Nov 18 2008
		 * Downloaded from : http://gsolofp.blogspot.com/2006/01/actionscript-3-md5-and-sha1.html   
		...
		public static function rstr2binl (input:String):Array {
		  ...
		  for(var i:Number = 0; i < output.length; i++)
		    output[i] = 0;
		  for(var i1:Number = 0; i1 < input.length * 8; i1 += 8)
		    output[i1>>5] |= (input.charCodeAt(i1 / 8) & 0xFF) << (i1%32);
		  return output;
		}
